...
![](./img/04.%20Versioning.png)

Corrected version

![](./img/05%20corrected%20version.png)
...
![](./img/06.%20AutomateReleases.png)

Corrected GitHub Action: Create Release on Tag Push:
![](./img/07%20corrected%202.png)
