...
![](./img/04.%20Block%20public%20access.png)

c) Additionally, leave Bucket Versioning disabled.

![](./img/05.%20Bucket%20Version%20Disabled.png)

d) Proceed with the default settings.

![](./img/06.%20Default%20encryption.png)


e) Once done, click on the "Create bucket" button to finalize the creation process.

![](./img/07.Create%20Bucket.png)
![](./img/08.%20Bucket%20Created.png)
...
Now, let's move on to the second part, where we'll upload an object into the bucket named 'adetunjibucket'.

1. Let's create a file on our laptop with some data. We'll write 'Welcome to the AWS world' and save the file.

![](./img/11.Welcome%20to%20AWS%20World.png)
...
![](./img/16.Bucketversioning%20Disabled.png)
...
![](./img/18.Enable%20Versioning.png)
...
5. Now, lets you modify the content of the file and upload it again, you'll create a new version of the file.

![](./img/19.Change%20words.png)

a) By clicking on "Show versions," you'll be able to see all the versions of the file you've uploaded.

![](./img/20.Show%20Versions.png)
...
![](./img/25.Bucket%20Policy.png)

5. Now, click on the "Policy generator".
...
My ARN- arn:aws:s3:::adetunjibucket

And we need to add /* at the end of the ARN

6. Note- ARN stands for Amazon Resource Name. It's like a unique address for every resource in AWS, such as buckets in S3. Just like your home address tells people where you live, an ARN tells AWS where a specific resource is located. It helps AWS know exactly which resource you're referring to when you're setting up permissions or policies.

I did not use policy generator as i could nott see it on my AWS.

![](./img/27.JSON%20ARN%20Code.png)

Save changes after inserting the code

![](./img/28.Save%20changes%20after%20inserting%20the%20code.png)
...
"Resource": "arn:aws:s3:::adetunjibucket/": This line specifies the AWS resource to which the policy applies. In this case, it applies to all objects (/) within the S3 bucket named adetunjibucket. The ARN (Amazon Resource Name) uniquely identifies the resource.
...
7. Now, click on this version of your file.

![](./img/30.First%20Version.png)

9. Click on the object url

![](./img/31.Version1%20URL.png)
![](./img/32.result.png)

10. Lets click to the latest version
And click on the object URL,
we’ll get the latest data.

![](./img/33.latest%20data.png)
...
![](./img/34.Create%20Lifesttyle%20policies.png)
