...
![](./img/9.Provide%20name%20for%20resources.png)
...
![](./img/12.Createpolicy%202.png)

2. Click on create policy

![](./img/13.Click%20create%20policy.png)

3. In the select a service section, search for S3

![](./img/14.Search%20S3.png)
...
![](./img/17.Analystdetails.png)


8. Click on Create Policy

![](./img/18.Create3s%20policy.png)

Policy created for analyst and available in AWS management by me.

![](./img/19.Analyst%20created.png)
...
![](./img/20.Usergroup.png)

2. Provide a name for the group
![](./img/21.Namegroup.png)
...
![](./img/22.Attach%20permissions.png)
...
![](./img/24.Create%20Anaylyst%20group.png)
...
![](./img/25.Analyst%20team%20name.png)
...
![](./img/26.Analyst%20Team%20Created.png)
...
![](./img/28.Iamuserjohn.png)

3. Permissions: Add user John to the development team group.

![](./img/29.Addusertoteam.png)

4. Click on Create user
![](./img/30.Createuser.png)

5. Download the login credentials for John

![](./img/31.JohnCreated.png)
...
3. Permissions: Add Mary to the Analyst team group.

![](./img/33.AddMarytoteam.png)


4. Click on Create user

![](./img/34.CreateuserMary.png)

5. Download the login credentials for Mary

![](./img/35.Mary%20Created.png)

Both user John and Mary created

![](./img/36.View%20Users.png)
...
![](./img/37.John%20Login.png)


 John AWS Dashbaord

 ![](./img/38.John%20login%20page.png)
...
![](./img/39.John%20Access%20to%20EC2.png)
...
![](./img/40.EC2%20Instance%20John.png)
...
![](./img/41.Mary%20Login%20details.png)
...
![](./img/42.Mary%20Dashboard.png)

Mary S3 dashboard
![](./img/43.%20S3%20Mary.png)
...
![](./img/45.Johncannot%20s3.png)

Mary can not create EC2 instance

![](./img/46.Marycanot%20Ec2.png)

### Implement Multi-Factor Authentication (MFA)
Now that you have created new users. Let's create Multi-Factor Authentication for John. But before we to that, what is MFA ?
...
![](./img/48.EnableMFA%20for%20John.png)

3. Enter a device name for john MFA and select authenticator app

![](./img/49.MFA%20Authenticator.png)
...
![](./img/52.User%20Mary.png)


2. Click on enable MFA as shown in the image below
3. Enter a device name for john MFA and select authenticator app

![](./img/53.Mary%20MFA.png)
...
![](./img/55.Authenticator%20App.png)

6. By completing step 1-5, MFA will be enabled for Mary.

![](./img/56.MFA%20Assigned%20for%20Mary.png)
