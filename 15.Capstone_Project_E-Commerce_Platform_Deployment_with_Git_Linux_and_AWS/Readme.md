...
![](./2.Extract%20website%20template.png)
...
![](./img/4.Stageand%20commit%20template.png)
...
![](./img/5.Creategithub%20repository.png)

![](./img/6.Github%20repository%20created.png)
...
Link Your Local Repository to GitHub: In our terminal, within our project directory, add the remote repository URL to our local repository configuration.
 ...
 git remote add origin https://github.com/Adetunji-Olaniyi/MarketPeak_Ecommerce.git

![](./img/7.Link%20to%20github.png)
...
![](./img/Gitpush%20origin%20master.png)
![](./img/8.Gitpush%20origin%20master.png)
...
![](./img/9.AWS%20Management%20Control.png)

- Launch an EC2 instance using an Amazon Linux AMI.

![](./img/10.%20EC2%20Instance.png)


- Connect to the instance using SSH.

![](./img/11.Connect%20to%20EC@.png)
...
![](./img/15.codegenerated%20ssh.png)

Display and Copy your public key

cat /home/ec2-user/.ssh/id_rsa.pub

![](./img/17.Public%20Key.png)

**Note:** Your ssh public key will different

Add the SSH public key to your GitHub account.

![](./img/18.Addto%20Github%20account.png)

![](./img/19.AddSSH%20.png)

- Use the SSH clone URL to clone the repository:

git clone git@github.com:Adetunji-Olaniyi/MarketPeak_Ecommerce.git
...
git clone https://github.com/Adetunji-Olaniyi/MarketPeak_Ecommerce.git

![](./img/21.Http%20Method.png)
...
![](./img/22.Sumyumupdate.png)

 sudo yum install httpd -y

 ![](./img/23.%20sudo%20ym%20intsall%201.png)

 ![](./img/22.sudoyumstall2.png)

sudo systemctl start httpd

 ![](./img/24.systemstart.png)



 sudo systemctl enable httpd

![](./img/25.Sudosystemenable.png)
...
My web page using ec2 IP: 18.232.157.188
