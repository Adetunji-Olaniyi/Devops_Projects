...
## if statement
The if statement in Bash scripts allows us to execute commands based on conditions. c

The basic syntax is:

![](./img/6.If%20command.png)
...
- r fi: Ends the if statement. It's basically if spelled backward, indicating the conclusion of the conditional block.

Now lets bring it into our code.

![](./img/7.%20if%20command%202.png)
...
Let run the code and experience the output, screenshot below:

![](./img/9.%20If%20command%204.png)


Tip: always read your shall script line by line to get a sense of what it is doing
...
![](./img/11.Elif%20complete%20command.png)
...
![](./img/12.run%20elif%20command.png)
...
![](./img/14.forloop%20example.png)

Code output

![](./img/15.loopcommand%20output.png)
...
![](./img/16.forloopstyles.png)

2. Insert the code in the file

![](./img/17.catstyles.png)
...
![](./img/21.%20execute%20csstyle.png)
