...
![connecttoserver](./img/1.Connect%20to%20Ubuntu%20Server.png)
...
![](./img/2.try%20creating%20root%20folder.png)

3. Observe the failure encounter a permission denied error like this:
...
![sudocreatedirectory](./img/3.usesudotocreate%20folder.png)
...
![sudolsroot](./img/4.sudo%20ls%20root.png)
...
![](./img/Snipaste_2026-03-24_22-51-22.png)
...
![rootfolder](./img/6.%20root%20folder.png)
...
sudo cd /usr : nb: i used it without sudo
...
![](./img/12.createrandon%20directories.png)

5. Navigate into one of them

cd Dev1

![navigatedirectory](./img/13.navigate%20into%20directory.png)

6. Show the full path where you currently are on the screen

pwd

![](./img/14.showdirectory.png)
...
![lscommands](./img/15.lscommands.png)
...
![catcommand](./img/16.catcommand.png)
