...
![AWSAccount](./img/6.AWS%20Accouuntt.png)
...
![EC2Instance](./img/7.EC2%20Instance.png)

## Connecting to Server

![Connecting](./img/8.Connecting%20to%20server.png)



Connecting using SSH, I use a Mac, so the Terminal is already available.



I will open my terminal and connect to my remote server using SSH.
...
code:  ssh -i "ubuntu.pem" ubuntu@public_ip_address

![](./img/Connecting%20ot%20server%203.png)
...
![SSH](./img/9.Connecting%20to%20server.png)
...
1. Installing, Updating and Removing Software
...
![sudoaptupdate](./img/10.Sudoaptupdate.png)
...
![installtree](./img/11.sudoaptintalltree.png)
...
![sudoaptupgrade](./img/12.sudoaptupgrade.png)

![](./img/12.sudoaptupgrade2.png)

5. Removing Software Package To remove the tree package we installed earlier, run the below command

sudo apt remove tree

![removetree](./img/13.sudoaptremovetree.png)
