...
Imagine building a virtual space for the company called GatoGrowFast.com's so that the computers can communicate securely. That's what VPC, or Virtual Private Cloud, is all about. It's like creating a private room in the cloud just for GatoGrowFast.com's use.
...
![](./img/0.1%20CIDR%20calculation.png)
...
![](./img/05.%20ifissue.png)

This is the VPC we have created:

![](./img/06.%20Vpc%20created.png)
...
![](./img/09.My%20public%20Network.png)
...
![](./img/10.My%20private%20subnet.png)

Our Architecture After subnet created

![](./img/11.ArchitectDiagram.png)

Here we’ll see our subnets is being created.

![](./img/12.Network%20Created.png)
...
![](./img/16.Detached%20gateway.png)
![](./img/17.%20Attach%20VPC%20.png)

Now, attach it to the VPC

![](./img/18.Attach%20VPC%20page.png)

![](./img/19.VPC%20attached.png)

Our Updated AWS Architect

![](./img/20.updatedArchitect.png)
...
![](./img/21.Route%20table%20page.png)
...
![](./img/22.route%20table%20page%202.png)
...
![](./img/23.%20Edit%20subnet.png)

3. Choose the public subnet and click on save association.
![](./img/24.Choose%20public%20subnnet.png)

4. Navigate to "Routes" and then click on "Edit routes."

![](./img/25.edittt%20routes.png)

5. Click on add route.

![](./img/26.add%20routes.png)
...
![](./img/28.route%20created.png)

Our Updated AWS Architect
![](./img/29.updatedarchitect.png)
...
10. Then click on the "route table ID " - In my own case - rtb-01e1dab15f95b8fbb
![](./img/35.My%20private%20subnet.png)

11. Proceed to the "Routes" section, then click on "Edit routes."
![](./img/36.Edit%20route.png)

12. Then click on “Add routes.”

![](./img/37%20Add%20route%20page.png)
...
![](./img/41.Subnet%20Associations.png)

Our Updated AWS Architect

![](./img/42.UpdatedArchitect.png)
...
## Part -6
Let's begin by creating two VPCs in the same region. Alternatively, we may choose a different region if needed.

![](./img/44.requester%20VPC.png)

![](./img/45.accepter%20VPS.png)
...
![](./img/49.Accept%20request.png)

5. Click on Accept request.

![](./img/50.Accept%20request%202.png)

Now, click on Main route table ID of the accepter VPC.

![](./img/51.Mainroute%20table.png)
![](./img/52.mainroute%20table%202.png)
...
![](./img/53.%20Route%20table.png)

c) Click on add route.
![](./img/54.Click%20add%20route.png)
...
![](./img/61.Peering%20connection.png)

![](./img/62.%20Changes%20saved.png)
...
![](./img/65.%20resolveissuewithEndpoint.png)
