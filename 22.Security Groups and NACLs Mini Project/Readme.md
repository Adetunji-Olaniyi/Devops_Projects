...
![](./img/1.My%20test%20instance.png)

5. Please navigate to the "Create VPC" option and click on it.
![](./img/2.Create%20VPC%20option.png)

6. Select the "VPC only" option, specify the IPv4 CIDR block, and proceed by clicking on the "Create VPC" button.


7. Let's navigate to the "Subnets" option located on the left sidebar.

a) Upon clicking, you will be directed to the "Subnets" page.

b) From there, proceed to click on the "Create subnet" button.

8. Now, let's enter the subnet name, and specify the IPv4 CIDR for the subnet.
...
![](./img/04.%20AccessWebWithPUBIP.png)
...
![](./img/05.%20UnreachableWebAddress.png)
...
![](./img/08.%20AddRule.png)

c) Now, select "HTTP" as the type.

![](./img/09.SelectHTTP.png)
...
![](./img/15.%20ChangeSG.png)

4. Choose the security group you created.

![](./img/16.%20selectSG.png)
...
![](./img/34.UpdateOutbound.png)

![](./img/35.OutboundAdded.png)
![](./img/36.InboundNone.png)

Now, let’s see if we can access the website
![](./img/37.%20NoWebpage.png)
...
![](./img/51.%20Associated.png)

As soon as you have attached this NACL to your public subnet, and then you try to access the website again by typing the URL http:107.20.35.178, you will notice that you are unable to see the website Note: There is change in Public IP because the Instance was stopped and start in another day.

![](./img/52.webnotreahable.png)
...
![](./img/53.%20allowTraffic.png)
![](./img/54.OutboundDeny.png)
![](./img/55.%20NetSetup.png)
...
![](./img/61.AddSSHandHTTP.png)
![](./img/62.SaveInbound.png)
![](./img/63.IPV4alltraffic.png)
