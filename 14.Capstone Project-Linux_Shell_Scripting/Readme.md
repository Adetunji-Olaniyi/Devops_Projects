...
![](./img/1.create%20shell.png)

### Function to generate table using list-form loop:

![](./img/2.listformloop.png)

### Function to generate table using C-style loop

![](./img/3.Cstyle%20function.png)

### Main Script

![](./img/4.Mainscript1.png)

![](./img/6.Mainscript2.png)

### Code OutPut

Partial Table Multiplication of 3

![](./img/7.%20code%20input.png)

## Handling Invalid Range if user enters an invalid range

![](./img/8.Handling%20invalid%20range.png)

## Code output in ascending and decending order

![](./img/9.Code%20in%20ascending%20order.png)

![](./img/10.code%20in%20descending%20order.png)
