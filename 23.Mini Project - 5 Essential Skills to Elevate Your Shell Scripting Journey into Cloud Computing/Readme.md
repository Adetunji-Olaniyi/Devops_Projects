...
Automatically create EC2 instances and S3 buckets on AWS.

Handle multiple resources efficiently using arrays.

Keep configurations and credentials secure using environment variables.

Be flexible enough to adapt to different deployment needs through command line arguments.

Be resilient and professional through proper error handling.
...
![](./img/0.1%20Ubuntu.png)

![](./img/00.settingupenvvariable.png)
![](./img/01.png)
![](./img/02.png)
![](./img/03.png)
![](./img/04.png)
...
Checking my AWS console management, EC2 instance successfully launch
![](./img/08.EC2IntsanceCreated.png)

Checking my AWS console management, S3 Bucket successfully created
![](./img/09.S3BucketCreated.png)
