...
![](./img/02.%20runcommand.png)
Below is an example of how you would create EC2 instances using the command line.

![](./img/03.InstanceRunCommand.png)
![](./img/04.IntanceRunCommand.png)
...
![](./img/12.S3Function.png)
![](./img/12.S3Function.png)
![](./img/13.S3function.png)
![](./img/14.succescreatingS3.png)
![](./img/S3ontheconsole.png)
