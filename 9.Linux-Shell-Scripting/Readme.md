...
![](./img/8.make%20executable.png)

* Run the shell script.

![](./img/9.run%20script.png)
...
From the example above, "Adetunji" was asigned to the variable "name".

![](./img/11..Assign%20name.png)

## Retrieving value from a variable
After assigning a value to a variable, as shown in the previous example where we assigned "Adetunji" to the variable name, we can utilize this variable in various ways in our script or program. One of the most straightforward methods to use or retrieve the value stored in a variable is by echoing it back to the console. This is done using the echo command in shell scripting.

`echo $name`

![](./img/12.%20Echoname.png)

This command instructs the shell to print the value of name to our screen, which, in our case, would output Adetunji.

![](./img/13.mynameis%20name.png)
