...
![](./img/0.3%20AWS%20Roles.png)

## What is IAM Policy?

An IAM policy is a set of rules that define what actions a role can take. These rules specify the permissions granted to the role. Think of a policy as a rulebook for the role. 

It outlines which actions are allowed and which are not, helping to ensure secure and controlled access to your AWS resources.
...
![](./img/0.7%20EC2%20Search.png)

3. Now, select all EC2 actions.

![](./img/0.8%20All%20EC2%20Actions.png)

4. Tick "All resources" and click "Next."

![](./img/0.9%20All%20Resources.png)

5. Now click on create policy

![](./img/10.%20Policy%20for%20Eric.png)
![](./img/11.Create%20Policy%20for%20eric.png)

This is the policy we have created.

![](./img/12.Eric%20policy%20Created.png)

6. Now, proceed to the "Users" section, and select the option to "Create User."

![](./img/12.%20Navigate%20to%20user.png)
...
![](./img/13.%20Specify%20User%20details.png)
...
![](./img/14.Set%20Eric%20Permissions.png)
...
![](./img/15.Review%20and%20create%20user.png)
![](./img/16.Retrive%20Password.png)
...
![](./img/17.%20IAM%20GROUP.png)
![](./img/18.%20IAM%20GROUP%202.png)

This is the user you've created.

c) Now, let's proceed to the "User Group.

![](./img/19.IAM%20Group%20Created.png)

2. Now, let's create a user named Jack.

![](./img/20.Create%20User%20Jack.png)
![](./img/21.%20Specify%20jack%20details.png)
...
![](./img/22.%20Add%20jack%20to%20group.png)

4. Now, click on create user
![](./img/23.%20Click%20Create%20User.png)

We need to repeat the same process for user Ade. Create user Ade and add him to the user group "Development_team."

![](./img/24.%20Create%20Ade.png)

![](./img/25%20Create%20Ade%202.png)

![](./img/26.%20Create%20Ade%203.png)

5. Navigate to the "Policies" section and click on "Create Policy" to begin crafting a new policy.

![](./img/27.%20Create%20Policy.png)

6. Choose the two services, EC2 and S3, from the available options.

![](./img/28.%20Create%20EC2%20Policy.png)
![](./img/29.Create%20s3%20Action.png)

7. Enter the desired policy name and proceed to click on the "Create policy" button.

![](./img/30.%20Policy%20Name.png)

8. Navigate to the "Users group" section and select the "Development-team" group.
![](./img/31.%20Navigate%20to%20Development%20Team.png)

9. Proceed to the "Permissions" section and add the necessary permissions.
![](./img/32.Go%20to%20Permisions.png)

10. Click on attach policy
![](./img/33.%20Click%20attach%20policies.png)

11. Select "Customer Managed Policy" as the policy type.
a) Then choose the "development_policy" we created.

b) click "Attach Policy."

![](./img/34.%20Development%20Team%20Policy.png)


The policy is now attached to the group, granting full permissions to EC2 and S3 for the group's users.

![](./img/35.Policy%20attched.png)
